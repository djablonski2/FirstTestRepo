 ...
 * 
 */
public class TCProcessingCall_Generic_Test {
	...
	public void main() throws Exception {
		try {
			...
			AddNewCall_Action.Execute("Zamówienie transmisji GENERIC",5);
				js.executeScript("document.getElementById('topNav').style.display = 'none';");
			FillNewCall_Action.Execute_Generic(".WROCLAW", "Bełchatów (Kwiatowa 1) - 6052", "Białystok (TP Emitel Cieszyńska 3) - 9001", "128000");
				js.executeScript("document.getElementById('topNav').style.display = 'none';");
